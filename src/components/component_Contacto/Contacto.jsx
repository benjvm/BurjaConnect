    ...
    <div id="contacto">
      <div id="todo_contactos">
        ...
        <div>
          <h2>CONTACTO</h2>
          <div id="contacto_txt">
            <p><strong>Horario:</strong> Lunes a Viernes - 9:00 a 14:00</p>
            <p><strong>Teléfono:</strong> 96 316 05 00</p>
            <p><strong>Email:</strong> registro@burjassot.es</p>
            <p><strong>Dirección:</strong> Plaça Emilio Castelar, 1, 46100 Burjassot, Valencia, España</p>
          </div>

        </div>
      </div>
      <div id="ayunt_googlemap">
        <h2>ENCUENTRANOS</h2>
        {googlemapa()}
      </div>
    </div>
